...
import com.example.medicapp_vip.databinding.FragmentHello3Binding
import com.example.medicapp_vip.view.activity.LoginActivity

class Hello3Fragment : Fragment() {
    private lateinit var binding: FragmentHello3Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentHello3Binding.inflate(layoutInflater)
        setting()
        return binding.root
    }
